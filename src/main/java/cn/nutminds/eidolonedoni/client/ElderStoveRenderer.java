package cn.nutminds.eidolonedoni.client;

import cn.nutminds.eidolonedoni.block.ElderStoveBlock;
...
public class ElderStoveRenderer implements BlockEntityRenderer<ElderStoveBlockEntity> {
	public ElderStoveRenderer(BlockEntityRendererProvider.Context context) {
    }
    @Override
    public void render(ElderStoveBlockEntity stoveEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLightIn, int combinedOverlayIn) {
        Direction direction = stoveEntity.getBlockState().getValue(ElderStoveBlock.FACING).getOpposite();
